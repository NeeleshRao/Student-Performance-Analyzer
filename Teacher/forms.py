...
class single_phase(Form):
    rubrics1 = IntegerField(
        "CO rubrics1", validators=[DataRequired(), NumberRange(min=1, max=10)]
    )
    rubrics2 = IntegerField(
        "CO rubrics2", validators=[DataRequired(), NumberRange(min=1, max=10)]
    )
    rubrics3 = IntegerField(
        "CO rubrics3", validators=[DataRequired(), NumberRange(min=1, max=10)]
    )
    rubrics4 = IntegerField(
        "CO rubrics4", validators=[DataRequired(), NumberRange(min=1, max=10)]
    )
    rubrics5 = IntegerField(
        "CO rubrics5", validators=[DataRequired(), NumberRange(min=1, max=10)]
    )
    rubrics6 = IntegerField(
        "CO rubrics6", validators=[DataRequired(), NumberRange(min=1, max=10)]
    )

    rubrics1m = IntegerField(
        "Marks rubrics1", validators=[DataRequired(), NumberRange(min=1, max=5)]
    )
    rubrics2m = IntegerField(
        "Marks rubrics2", validators=[DataRequired(), NumberRange(min=1, max=5)]
    )
    rubrics3m = IntegerField(
        "Marks rubrics3", validators=[DataRequired(), NumberRange(min=1, max=5)]
    )
    rubrics4m = IntegerField(
        "Marks rubrics4", validators=[DataRequired(), NumberRange(min=1, max=5)]
    )
    rubrics5m = IntegerField(
        "Marks rubrics5", validators=[DataRequired(), NumberRange(min=1, max=5)]
    )
    rubrics6m = IntegerField(
        "Marks rubrics6", validators=[DataRequired(), NumberRange(min=1, max=5)]
    )
...
class small_crsend(Form):
    ...
    g = IntegerField(
        "Good", validators=[NumberRange(min=1, max=10), Optional(strip_whitespace=True)]
    )
    sat = IntegerField(
        "Satisfactory",
        validators=[NumberRange(min=1, max=10), Optional(strip_whitespace=True)],
    ...
    poor = IntegerField(
        "poor", validators=[NumberRange(min=1, max=10), Optional(strip_whitespace=True)]
    )
    co = IntegerField(
        "CO Mapped",
        validators=[NumberRange(min=1, max=10), Optional(strip_whitespace=True)],
